...
export const users = [
  ...
  export const products =  [

    {
      ...
      brand: 'Quilmes',
      supplyingCompany: 'Cervecería y Maltería Quilmes',
      category: 'Bebidas',
      ...
      priceList: [
        ...
        { price: 400, unitsNeeded: 25 },
        { price: 350, unitsNeeded: 40 },
      ],
      imgUrl: 'https://www.sharpsbrewery.co.uk/cdn/shop/products/offshore-glass-pint.jpg?v=1666181238',
    },
    {
        productId: '2',
      name: 'Pan',
